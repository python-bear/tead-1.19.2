...
public class TeadBlocks {
    ...
    public static final Block LEAD_ORE = registerBlock("lead_ore",
            new OreBlock(FabricBlockSettings.copyOf(Blocks.IRON_ORE), UniformIntProvider.create(0, 1)));
    public static final Block RUBY_ORE = registerBlock("ruby_ore",
            new OreBlock(FabricBlockSettings.copyOf(Blocks.EMERALD_ORE),
                    UniformIntProvider.create(4, 8)));
    public static final Block DEEPSLATE_RUBY_ORE = registerBlock("deepslate_ruby_ore",
            new OreBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_EMERALD_ORE),
                    UniformIntProvider.create(4, 8)));
    public static final Block GOLD_CHAIN = registerBlock("gold_chain",
            new ChainBlock(FabricBlockSettings.copyOf(Blocks.CHAIN).mapColor(MapColor.GOLD)
                    .strength(4.0f, 5.0f).nonOpaque().requiresTool().dynamicBounds()));
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(Tead.MOD_ID, name), block);
    }
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registry.ITEM, new Identifier(Tead.MOD_ID, name),
