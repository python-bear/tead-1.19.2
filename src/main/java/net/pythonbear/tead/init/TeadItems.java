...
import net.pythonbear.tead.item.HoeItem;
...
public class TeadItems {
    ...
    public static final Item SWIFTNESS_BOOTS = registerItem("swiftness_boots",
            new SwiftnessArmorItem(TeadArmorMaterials.SWIFTNESS, EquipmentSlot.FEET, new FabricItemSettings()));
    public static final Item GOLD_CHAINMAIL_HELMET = registerItem("gold_chainmail_helmet",
            new ArmorItem(TeadArmorMaterials.GOLD_CHAIN, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item GOLD_CHAINMAIL_CHESTPLATE = registerItem("gold_chainmail_chestplate",
            new ArmorItem(TeadArmorMaterials.GOLD_CHAIN, EquipmentSlot.CHEST, new FabricItemSettings()));
    public static final Item GOLD_CHAINMAIL_LEGGINGS = registerItem("gold_chainmail_leggings",
            new ArmorItem(TeadArmorMaterials.GOLD_CHAIN, EquipmentSlot.LEGS, new FabricItemSettings()));
    public static final Item GOLD_CHAINMAIL_BOOTS = registerItem("gold_chainmail_boots",
            new ArmorItem(TeadArmorMaterials.GOLD_CHAIN, EquipmentSlot.FEET, new FabricItemSettings()));
    public static final Item ROBE_HELMET = registerItem("robe_helmet",
            new RobeArmorItem(TeadArmorMaterials.ROBE, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item ROBE_CHESTPLATE = registerItem("robe_chestplate",
            new RobeArmorItem(TeadArmorMaterials.ROBE, EquipmentSlot.CHEST, new FabricItemSettings()));
    public static final Item ROBE_BOOTS = registerItem("robe_boots",
            new RobeArmorItem(TeadArmorMaterials.ROBE, EquipmentSlot.FEET, new FabricItemSettings()));
    public static final Item GOLD_STALWART_HELMET = registerItem("gold_stalwart_helmet",
            new StalwartArmorItem(TeadArmorMaterials.GOLD_STALWART, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item GOLD_STALWART_CHESTPLATE = registerItem("gold_stalwart_chestplate",
            new StalwartArmorItem(TeadArmorMaterials.GOLD_STALWART, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item IRON_STALWART_HELMET = registerItem("iron_stalwart_helmet",
            new StalwartArmorItem(TeadArmorMaterials.IRON_STALWART, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item IRON_STALWART_CHESTPLATE = registerItem("iron_stalwart_chestplate",
            new StalwartArmorItem(TeadArmorMaterials.IRON_STALWART, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item DIAMOND_STALWART_HELMET = registerItem("diamond_stalwart_helmet",
            new StalwartArmorItem(TeadArmorMaterials.DIAMOND_STALWART, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item DIAMOND_STALWART_CHESTPLATE = registerItem("diamond_stalwart_chestplate",
            new StalwartArmorItem(TeadArmorMaterials.DIAMOND_STALWART, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item NETHERITE_STALWART_HELMET = registerItem("netherite_stalwart_helmet",
            new StalwartArmorItem(TeadArmorMaterials.NETHERITE_STALWART, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item NETHERITE_STALWART_CHESTPLATE = registerItem("netherite_stalwart_chestplate",
            new StalwartArmorItem(TeadArmorMaterials.NETHERITE_STALWART, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item GOLD_HIGHLAND_HELMET = registerItem("gold_highland_helmet",
            new HighlandDyableArmorItem(TeadArmorMaterials.GOLD_HIGHLAND, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item GOLD_HIGHLAND_CHESTPLATE = registerItem("gold_highland_chestplate",
            new HighlandDyableArmorItem(TeadArmorMaterials.GOLD_HIGHLAND, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item IRON_HIGHLAND_HELMET = registerItem("iron_highland_helmet",
            new HighlandDyableArmorItem(TeadArmorMaterials.IRON_HIGHLAND, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item IRON_HIGHLAND_CHESTPLATE = registerItem("iron_highland_chestplate",
            new HighlandDyableArmorItem(TeadArmorMaterials.IRON_HIGHLAND, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item DIAMOND_HIGHLAND_HELMET = registerItem("diamond_highland_helmet",
            new HighlandDyableArmorItem(TeadArmorMaterials.DIAMOND_HIGHLAND, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item DIAMOND_HIGHLAND_CHESTPLATE = registerItem("diamond_highland_chestplate",
            new HighlandDyableArmorItem(TeadArmorMaterials.DIAMOND_HIGHLAND, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item NETHERITE_HIGHLAND_HELMET = registerItem("netherite_highland_helmet",
            new HighlandDyableArmorItem(TeadArmorMaterials.NETHERITE_HIGHLAND, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item NETHERITE_HIGHLAND_CHESTPLATE = registerItem("netherite_highland_chestplate",
            new HighlandDyableArmorItem(TeadArmorMaterials.NETHERITE_HIGHLAND, EquipmentSlot.CHEST,
                    new FabricItemSettings()));
    public static final Item GOLD_ROYAL_HELMET = registerItem("gold_royal_helmet",
            new RoyalArmorItem(TeadArmorMaterials.GOLD_ROYAL, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item IRON_ROYAL_HELMET = registerItem("iron_royal_helmet",
            new RoyalArmorItem(TeadArmorMaterials.IRON_ROYAL, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item DIAMOND_ROYAL_HELMET = registerItem("diamond_royal_helmet",
            new RoyalArmorItem(TeadArmorMaterials.DIAMOND_ROYAL, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item NETHERITE_ROYAL_HELMET = registerItem("netherite_royal_helmet",
            new RoyalArmorItem(TeadArmorMaterials.NETHERITE_ROYAL, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item GOLD_PLATE_HELMET = registerItem("gold_plate_helmet",
            new PlateArmorItem(TeadArmorMaterials.GOLD_PLATE, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item GOLD_PLATE_CHESTPLATE = registerItem("gold_plate_chestplate",
            new PlateArmorItem(TeadArmorMaterials.GOLD_PLATE, EquipmentSlot.CHEST, new FabricItemSettings()));
    public static final Item GOLD_PLATE_BOOTS = registerItem("gold_plate_boots",
            new PlateArmorItem(TeadArmorMaterials.GOLD_PLATE, EquipmentSlot.FEET, new FabricItemSettings()));
    public static final Item IRON_PLATE_HELMET = registerItem("iron_plate_helmet",
            new PlateArmorItem(TeadArmorMaterials.IRON_PLATE, EquipmentSlot.HEAD, new FabricItemSettings()));
    public static final Item IRON_PLATE_CHESTPLATE = registerItem("iron_plate_chestplate",
            new PlateArmorItem(TeadArmorMaterials.IRON_PLATE, EquipmentSlot.CHEST, new FabricItemSettings()));
    public static final Item IRON_PLATE_BOOTS = registerItem("iron_plate_boots",
            new PlateArmorItem(TeadArmorMaterials.IRON_PLATE, EquipmentSlot.FEET, new FabricItemSettings()));
    public static final Item DIAMOND_PLATE_HELMET = registerItem("diamond_plate_helmet",
            new PlateArmorItem(TeadArmorMaterials.DIAMOND_PLATE, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item DIAMOND_PLATE_CHESTPLATE = registerItem("diamond_plate_chestplate",
            new PlateArmorItem(TeadArmorMaterials.DIAMOND_PLATE, EquipmentSlot.CHEST, new FabricItemSettings()));
    public static final Item DIAMOND_PLATE_BOOTS = registerItem("diamond_plate_boots",
            new PlateArmorItem(TeadArmorMaterials.DIAMOND_PLATE, EquipmentSlot.FEET, new FabricItemSettings()));
    public static final Item NETHERITE_PLATE_HELMET = registerItem("netherite_plate_helmet",
            new PlateArmorItem(TeadArmorMaterials.NETHERITE_PLATE, EquipmentSlot.HEAD,
                    new FabricItemSettings()));
    public static final Item NETHERITE_PLATE_CHESTPLATE = registerItem("netherite_plate_chestplate",
            new PlateArmorItem(TeadArmorMaterials.NETHERITE_PLATE, EquipmentSlot.CHEST, new FabricItemSettings()));
    public static final Item NETHERITE_PLATE_BOOTS = registerItem("netherite_plate_boots",
            new PlateArmorItem(TeadArmorMaterials.NETHERITE_PLATE, EquipmentSlot.FEET, new FabricItemSettings()));
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registry.ITEM, new Identifier(Tead.MOD_ID, name), item);
    }
